...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parse_map_details_aux_bonus.c                      :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: cgutierr <cgutierr@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/17 14:48:12 by cgutierr          #+#    #+#             */
/*   Updated: 2021/04/24 12:14:15 by cgutierr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_map_details(t_cub *cub)
{
	...
	if (cub->num_tp > 2 || cub->num_tp == 1)
	{
		print_simple_errors("There should only be two teleport points");
		free_content_map_matrix(cub);
		free_content_cub(cub);
		exit(1);
	}
