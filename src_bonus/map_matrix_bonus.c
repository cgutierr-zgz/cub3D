...
/*   Updated: 2021/04/27 17:36:51 by cgutierr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	store_sprites(t_cub *cub, int z, char c)
{
	t_sprite	*sprite;

	sprite = malloc(sizeof(t_sprite));
	each_sprite(c, cub, &sprite, z);
...
static void	map_check_fill(char *c, int z, t_cub *cub)
{
	if (c[z] == '0')
		...
		cub->map.map_matrix[cub->map.matrix_act][z] = '9';
	else if (c[z] >= '2' && c[z] <= '5')
		store_sprites(cub, z, c[z]);
